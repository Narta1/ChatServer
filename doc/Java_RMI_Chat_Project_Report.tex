...
Then go in code repository, compile with "javac *.java". Start the server using "java Server" and the clients using "java Client username" or "java ClientGUI username" depending
